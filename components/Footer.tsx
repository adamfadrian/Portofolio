        ...
        <div>
            ...
            <footer className="footer footer-center mt-36 p-10 bg-base-200 dark:border-t-2 text-base-content rounded dark:bg-gradient-to-b dark:from-gray-800 dark:to-gray-800 bg-gradient-to-r from-blue-400 to-cyan-300">
                ...
                <div className="grid grid-flow-col gap-4 ">
                    <h1 className='font-medium text-lg dark:text-white'> Built with Typescript, React, Framer-Motion, daisyUI</h1>
                </div>
                <div>
                    <p className='font-medium dark:text-white text-xl'>Copyright © 2023 - All right reserved by Adam Fadrian</p>
                </div>
            </footer>
        </div>
    )
